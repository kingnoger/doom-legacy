...
//
// $Log$
// Revision 1.9  2004/08/19 19:42:41  smite-meister
// bugfixes
//
...
/// Equivalent states have been merged together (in states table too, of course)
enum statenum_t
{
  S_NULL,
...
///
/// Combining similar mobjtypes from different games:
/// If they have no doomednum (-1), it's OK.
/// If they do have one, they must remain separate.
enum mobjtype_t
{
  MT_NONE = -1, // like NULL
  MT_DOOM = 0,
