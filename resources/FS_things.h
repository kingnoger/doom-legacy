...
const MF_SOLID = 2;
const MF_SHOOTABLE = 3;
const MF_NOCLIP = 4;
const MF_NOCLIPLINE = 4;
const MF_NOCLIPTHING = 5;
const MF_NOGRAVITY = 6;
const MF_NOTRIGGER = 7;
const MF_NOTMONSTER = 8;
const MF_PICKUP = 9;
const MF_FLOAT = 10;
const MF_DROPOFF = 11;
const MF_AMBUSH = 12;
const MF_NOSPLASH = 13;
const MF_SHADOW = 14;
